...
void main() {
  test('filesystem store persists source and revision sidecar', () async {
    ...
    expect(
      File('${tempRoot.path}${Platform.pathSeparator}cloud${Platform.pathSeparator}main.styio')
          .existsSync(),
      isTrue,
    );
  });

  test('filesystem store reads and writes absolute project files directly',
      () async {
    final tempRoot = await Directory.systemTemp.createTemp(
